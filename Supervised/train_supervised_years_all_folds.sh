...
sbatch train_supervised.sh 90-95 $1 $2 $3

sbatch train_supervised.sh 96-01 $1 $2 $3

sbatch train_supervised.sh 02-07 $1 $2 $3

sbatch train_supervised.sh 08-13 $1 $2 $3

sbatch train_supervised.sh 14-19 $1 $2 $3
