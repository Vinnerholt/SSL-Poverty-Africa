...
sbatch train_moco_sup_country_fold.sh A $1 $2 

sbatch train_moco_sup_country_fold.sh B $1 $2

sbatch train_moco_sup_country_fold.sh C $1 $2

sbatch train_moco_sup_country_fold.sh D $1 $2

sbatch train_moco_sup_country_fold.sh E $1 $2
