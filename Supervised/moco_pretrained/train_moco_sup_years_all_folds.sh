...
#TRAIN ON FRACTIONS
# ARGUMENTS: $1 = save-dir, $2 = checkpoint-path, $X = MoCo epoch (specified with 4 digits, e.g. 0015 for 16 epochs of pretraining)
...
sbatch train_moco_sup_years_fold.sh 90-95 $1 $2 

sbatch train_moco_sup_years_fold.sh 96-01 $1 $2

sbatch train_moco_sup_years_fold.sh 02-07 $1 $2

sbatch train_moco_sup_years_fold.sh 08-13 $1 $2

sbatch train_moco_sup_years_fold.sh 14-19 $1 $2
...
#python supervised_training.py  --lr 0.02 --dist-url 'tcp://127.0.0.1:8896' --world-size 1 --rank 0 -j 4 --multiprocessing-distributed -b 128 --epochs 50 --fold $1 --save-dir $2/fold_$1 --folds-path /cephyr/NOBACKUP/groups/globalpoverty1/JesperBenjamin/CreateFolds/dhs_country_folds.pkl --resume $3
