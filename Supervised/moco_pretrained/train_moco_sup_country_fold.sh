...
echo SCRIPT STARTED
echo train_moco_sup_country_fold
...
python supervised_training.py  --lr 0.02 --dist-url 'tcp://127.0.0.1:8896' --world-size 1 --rank 0 -j 4 --multiprocessing-distributed -b 128 --epochs 30 --fold $1 --save-dir $2/fold_$1 --folds-path /cephyr/NOBACKUP/groups/globalpoverty1/JesperBenjamin/CreateFolds/dhs_country_folds.pkl --resume $3
