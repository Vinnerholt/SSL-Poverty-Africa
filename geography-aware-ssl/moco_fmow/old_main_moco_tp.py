...
train_csv = "/cephyr/NOBACKUP/groups/globalpoverty1/JesperBenjamin/geography-aware-ssl/csvs/test.csv"
temporal = True
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if temporal == False:
        ...
        aug = [
            ...
            #], p=0.8),
            #transforms.RandomGrayscale(p=0.2),
            # Does their implementation on GaussianBlur work on our multispectral data?
	    #transforms.RandomApply(
                #[moco.loader.GaussianBlur([.1, 2.])], p=0.5),
            transforms.RandomHorizontalFlip(),
            transforms.RandomVerticalFlip()
            # transforms.ToTensor(),
            # normalize FIX NORMALIZE FOR MULTISPECTRAL
        ]
